...
import com.asjngroup.deft.framework.generic.util.EntityRelationModel;
import com.asjngroup.deft.framework.generic.util.EntityRelationUtil;
...
public class EntityService implements IEntityService
{
	...
	*/
	...
	public List<EntityModel> getEntities( String entityName, String condition, List<Integer> partitions, Integer pageNum, Integer pageSize, Session session, CustomizeDataMapper customizeDataMapper,boolean isLinkReq )
	{
		...
		{
			e.printStackTrace();
			throw new DeftRuntimeException( "Model conversion failed", e );
		}
