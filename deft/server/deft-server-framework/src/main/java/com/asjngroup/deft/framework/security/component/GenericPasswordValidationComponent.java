...
import com.asjngroup.deft.common.BinaryHelper;
...
import com.asjngroup.deft.common.security.crypto.SecurityHelper;
...
public class GenericPasswordValidationComponent implements PasswordValidationInterface
{
	...
	private boolean disableUserLogin( LoginAttempt loginAttempt )
	{
		...
		{
			if ( hibernateSession != null && hibernateSession.getTransaction().getStatus()==TransactionStatus.ACTIVE )
			{
