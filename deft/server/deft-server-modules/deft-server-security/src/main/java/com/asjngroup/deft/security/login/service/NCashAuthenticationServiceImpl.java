...
import com.asjngroup.deft.common.database.hibernate.references.ConnectedUser;
import com.asjngroup.deft.common.database.hibernate.references.UserApplicationAccess;
import com.asjngroup.deft.common.database.hibernate.references.UserLoginInfo;
import com.asjngroup.deft.common.database.hibernate.references.UserPassword;
...
import com.asjngroup.deft.common.util.ResourceManager;
import com.asjngroup.deft.common.util.StringHelper;
import com.asjngroup.deft.common.util.StringUtil;
import com.asjngroup.deft.framework.security.component.PasswordValidationInterface;
import com.asjngroup.deft.framework.security.helper.SecurityHelper;
import com.asjngroup.deft.framework.security.model.LoginAttempt;
import com.asjngroup.deft.security.constant.AuthenticateConfigConstant;
...
public class NCashAuthenticationServiceImpl implements AuthenticationService
{
	...
	public static ArrayList<String> getLoadParameters()
	{
		...
		if ( logURL == null )
		{
			throw new DeftRuntimeException( "Failed to locate properties file - " + AuthenticateConfigConstant.PAGE_CONFIG_PROP_FILE_NAME );
		}
		...
		{
			throw new DeftRuntimeException( "Failed to read properties file - " + AuthenticateConfigConstant.PAGE_CONFIG_PROP_FILE_NAME );
		}
		finally
		{
			if ( null != openStream )
			{
				...
				{
					throw new DeftRuntimeException( "Failed to close properties file - " + AuthenticateConfigConstant.PAGE_CONFIG_PROP_FILE_NAME );
				}
			}
		}
