...
public class XMLTreeBuilder
{
    ...
    public XMLTreeBuilder( String packageName, Document doc, boolean isCamelCase )
    {
    ...
    private Object buildElementSubTree( Element element, int level ) throws XMLTreeException
    {
        ...
        for ( int i = 0; i < fields.length; i++ )
        {
            ...
            fieldMap.put(isCamelCase?field.getName() :StringHelper.lowerFirstChar( field.getName() ) , field );
        }
    ...
    {
        return Class.forName( packageName + "." + StringHelper.upperFirstChar(className) );
    }
