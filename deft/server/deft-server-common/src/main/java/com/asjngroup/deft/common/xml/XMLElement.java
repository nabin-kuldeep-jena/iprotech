...
public class XMLElement
{
    ...
    public String getProperty( String property, boolean required )
    {
        ...
        {
            throw new DeftRuntimeException( "The property '%1' is required but was not specified", property );
        }
    ...
    public XMLElement getSubStructure( String structureName, boolean required )
    {
        ...
        if ( required )
            throw new DeftRuntimeException( "Could not find required substructure '%1'", structureName );
