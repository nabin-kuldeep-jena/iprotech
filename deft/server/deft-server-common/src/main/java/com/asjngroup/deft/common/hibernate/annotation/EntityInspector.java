package com.asjngroup.deft.common.hibernate.annotation;
...
/**
 * User: nabin.jena Date: 25-Nov-2017 Time: 17:53:42
 */
public class EntityInspector<T> implements Serializable
{
	...
	public boolean isMandatory(String propertyName) {
		...
		if (joinColumn == null)
			throw new DeftRuntimeException(
	...
	public boolean isBasicProperty(String basicProperty) {
		...
		if (method == null)
			throw new DeftRuntimeException("Invalid property '%1'",
					basicProperty);
