package com.asjngroup.deft.common.database.helper;
...
public class SequenceNumberHelper
{
	...
	public long getNextId() throws HibernateException
	{
		...
		{
			throw new DeftRuntimeException( "id helper value has gone out of range. Current value is %1 max value is %2", new Object[]
