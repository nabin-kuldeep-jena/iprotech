...
//import { NCashConstants } from '../helper/ncashConstants';
...
export class LoginPage {
    ...
    doLogin(form) {
        ...
        if (form.controls.mobileNumber.errors || form.controls.password.errors)
            ...
            this.loginService.login(form).subscribe(
                data => {
                    ...
                    this.navCtrl.push(StoresPage, { preferredCityId: data[0].usrCtyId, preferredStateId: data[0].usrSteId });
                },
                err => {
        ...
        /*this.navCtrl.push(StoresPage, { preferredStateId:1, IP: form.controls.IP.value,
            port: form.controls.port.value });*/
    }
